...
public class _old_PermissionManager {
    ...
    //for testing overlay permissions
    ...
    public _old_PermissionManager(LeadMeMain main) {
        super();
        this.main = main;
    ...
    public boolean workThroughPermissions() {
        ...
        if (!canDraw && !Settings.canDrawOverlays(main)) {
    ...
    private void pingForAccess() {
        main.getHandler().post(new Runnable() {
            ...
            public void run() {
                ...
                Log.d(TAG, "ACCESSIBILITY granted!");
                main.recallToLeadMe();
            }
        });
    }
